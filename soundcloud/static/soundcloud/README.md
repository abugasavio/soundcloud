...
This will run all tests in the [`./soundcloud/static/soundcloud/__tests__`][test-dir] directory.
...
Open the lcov-report for an overview of your code coverage:
    ...
    $ open soundcloud/static/soundcloud/dist//reports/coverage/lcov-report/index.html
...
#### Source `./soundcloud/static/soundcloud/`
Main project source.

#### Actions `./soundcloud/static/soundcloud/actions/`
...
#### Components `./soundcloud/static/soundcloud/components/`
React components. Mostly __dumb__ components.

#### Constants `./soundcloud/static/soundcloud/constants/`
Stuff that doesn't change. Redux action types.

#### Containers `./soundcloud/static/soundcloud/containers/`
...
[test-dir]: /soundcloud/static/soundcloud/__tests__/
