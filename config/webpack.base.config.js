...
module.exports = (opts) => {
  ...
  return {
    ...
    entry: {
      main: path.resolve(PROJECT_ROOT, 'soundcloud/static/soundcloud/index'),
      vendor: ['react', 'redux', 'react-router', 'react-redux', 'react-dom'],
    },

    output: {
      path: path.resolve(PROJECT_ROOT, 'soundcloud/static/soundcloud/bundles'),
    ...
    resolve: {
      extensions: ['', '.js', '.jsx'],
      modules: [
        path.resolve(PROJECT_ROOT, 'soundcloud/static/soundcloud'),
        'node_modules',
      ],
    },
  };
