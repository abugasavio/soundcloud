...
Playing with soundcloud. Django backend, react frontend
...
.. _`static project readme`: soundcloud/static/soundcloud/README.md
...
.. code-block:: bash
    ...
    cd soundcloud
    celery -A soundcloud.taskapp worker -l info
